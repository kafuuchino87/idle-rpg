...
const SKILLS = {
  ...
  'void-cleave': {
    ...
    desc: '【終極奧義】魔劍劈裂虛空：1500% 攻擊力單體強擊，對 BOSS 額外 +80%（合計 2700% vs BOSS），必爆。施放後 10 秒：減傷 +25% + 攻速 +150%（突破上限至 14）+ 普攻附加 +100% 攻擊 + 強制觸發暗血盟（滿 +60% 攻）與背水之姫（+50% 攻 + 30% 暴傷）。CD 25s。',
  ...
  // ===== 世界 BOSS（跨玩家共用 HP，每天 00:00 Asia/Taipei 復活）=====
  {
    ...
    dungeons: [
      { id: 'world-boss-dragon', name: '焰心古龍', cp: 999999, unlock: 'raid-calamity', requiredLv: 99,
        ...
        warning: '世界 BOSS — 跨玩家共用 HP，每天 00:00 復活。**限定單人挑戰**，多人房需先離開房間。本場時限 30 秒，全部傷害即時上報後端、累積到當日傷害貢獻排行榜。戰敗也照樣上報。BOSS 被擊倒則當日結束，要等明日 00:00 復活。入場需消耗 1 張「焰心古龍試煉令」。',
        rewards: [
  ...
  // ===== 襲擊戰（Lv 99 endgame，超級難）=====
  {
    ...
    dungeons: [
      ...
      { id: 'raid-bloodscythe', name: '血鐮 · 罪薔薇祭壇', cp: 750000, unlock: 'raid-mirror', requiredLv: 99,
        minCpOverride: 450000,  // 入場門檻 45 萬 CP
        ...
        warning: '此為雙階 BOSS 副本（戀舞 → 血咒）。Phase 2 每 15 秒啟動「千年血契」護盾（5 億 HP），10 秒內不破則全隊即死。建議三人團 + 高 DPS 配置。',
        rewards: [
