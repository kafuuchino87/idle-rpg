    ...
    dungeons: [
      { id: 'endless-tower', name: '虛無之塔 · 鏡之終焉', cp: 200000, unlock: 'raid-calamity', requiredLv: 99,
        ...
        damageTiers: [
          ...
          { dmg: 45_000_000,  label: 'III', rewards: { mats: { '蝕痕碎片': 8, '蝕痕神核': 3, '終焉印石': 1 }, shard: 10 } },
          { dmg: 180_000_000, label: 'IV',  rewards: { mats: { '蝕痕碎片': 12, '蝕痕神核': 6, '終焉印石': 3 }, shard: 12 } },
          { dmg: 400_000_000, label: 'V',   rewards: { mats: { '蝕痕碎片': 20, '蝕痕神核': 10, '終焉印石': 6, '異界之鎚': 1 }, shard: 15 } },
        ],
        lore: [
          '在虛無之塔的頂端，鏡之終焉沉眠。',
          '他既無始亦無終 — 你能撼動他多少？',
        ...
        rewards: [
          ...
          { label: '階梯 III', value: '45M → +碎片 ×8、神核 ×3、印石 ×1、魂晶 +10', color: 'var(--exp)' },
          { label: '階梯 IV', value: '180M → +碎片 ×12、神核 ×6、印石 ×3、魂晶 +12（雙人合作）', color: 'var(--gold)' },
          { label: '階梯 V', value: '400M → +碎片 ×20、神核 ×10、印石 ×6、★異界之鎚 ×1、魂晶 +15（滿打累計 50，需三人團 + 畢業裝）', color: 'var(--hp-enemy)' },
      ...
      { id: 'raid-stardragon', name: '星淵 · 雙影獵討', cp: 600000, unlock: 'raid-calamity', requiredLv: 99,
        ...
        bosses: [
          ...
          { name: '虛宙星龍', portrait: 'assets/portraits/raid-dragon.png',
            ...
            shield: { firstAt: 40, interval: 40, hpFixed: 10_000_000, breakTime: 5 } },
        ],
